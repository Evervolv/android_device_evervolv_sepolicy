...
QCOM_EVERVOLV_SEPOLICY := device/evervolv/sepolicy/qcom
...
SYSTEM_EXT_PRIVATE_SEPOLICY_DIRS += \
    $(QCOM_EVERVOLV_SEPOLICY)/private

ifeq ($(TARGET_USES_PREBUILT_VENDOR_SEPOLICY), true)
SYSTEM_EXT_PRIVATE_SEPOLICY_DIRS += \
    $(QCOM_EVERVOLV_SEPOLICY)/dynamic \
    $(QCOM_EVERVOLV_SEPOLICY)/system
else
BOARD_VENDOR_SEPOLICY_DIRS += \
    $(QCOM_EVERVOLV_SEPOLICY)/dynamic \
    $(QCOM_EVERVOLV_SEPOLICY)/vendor
endif
